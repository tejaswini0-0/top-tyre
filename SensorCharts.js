                ...
                recentTimestamps.forEach((timestamp) => {
                  ...
                  if (entry) {
                    ...
                    if (entry.pressure) {
                      ...
                      const currentTime = Date.now();
                      if (pressValue < 25) {
                        if (currentTime - lastLowPressureAlertTime > 300000) {
                          addAlert('Low Pressure Alert', 'Pressure is below 25 psi!');
                          setLastLowPressureAlertTime(currentTime);
                          console.log('Low Pressure Alert shown');
                        }
                      } else if (pressValue > 38) {
                        if (currentTime - lastHighPressureAlertTime > 300000) {
